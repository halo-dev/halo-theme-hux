...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="/${theme.folderName}/source/css/bootstrap.min.css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="/${theme.folderName}/source/css/hux-blog.min.css">

    <!-- Pygments Github CSS -->
    <link rel="stylesheet" href="/${theme.folderName}/source/css/syntax.css">
